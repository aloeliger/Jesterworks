...
SMHTT2016Cuts.Cuts.append("againstElectronVLooseMVA6_2 && againstMuonTight3_2")
SMHTT2016Cuts.Cuts.append("nbtag==0")
SMHTT2016Cuts.Cuts.append("q_1 * q_2 < 0")
SMHTT2016Cuts.Cuts.append("byVLooseIsolationMVArun2v2DBoldDMwLT_2 && !byTightIsolationMVArun2v2DBoldDMwLT_2 && iso_1 < 0.15")
